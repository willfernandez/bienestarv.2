...
<body> 
 ...
 <div class="container" style="margin-top: 60px;">
	...
	<div class="row">
		<div class="span11">
			<h3>Introducción</h3> <hr />
			<p>
			Desde aqui Ud. podrá administrar las Fichas Socioeconómicas
			</p>
			<br />
			
			<h3>Acerca del sistema</h3>
			<br />
                        <img style="float:left;margin:0 15px;" src="images/logo2.png"></img><!-- AGREGAR IMAGEN -->
			<br />
			<p>
			...
			<div align="center">
				<strong>"OFICINA DE BIENESTAR"</strong>
			</div>
		</div>
	</div>
