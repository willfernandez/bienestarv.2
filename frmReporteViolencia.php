...
<body> 
 ...
 <div class="container" style="margin-top: 60px;width: 920px;">
     <div class="content">
    
<div class="page-header">
	<h1>Aspecto Convivencia<small>  Reportes</small></h1>
</div>
         ...
         <div class="well filtro">
                    ...
                    <tr>
                            ...
                            <td align="right">
                                <button class="btn btn-primary" type="submit" style="margin-top: -40px" onclick="ObsViolencia('<?php echo $_REQUEST['periodo'];?>','<?php echo $_REQUEST['carrera'];?>','<?php echo $_REQUEST['sede'];?>')">Ver estadisticas</button><br/>
                            </td>
                    </tr>
                    </table>
         </div>
            ...
            <div id="violenciaSN" style="height: 400px;"></div><br/><br/>
          <div id="TviolenciaSN"> </div>
           <div id="resumenAlumnos"> </div><br/>
          
          <div id="maltratoF" style="height: 400px;"></div><br/><br/>
          <div id="TmaltratoF"></div>
          <div id="resumenAlumnos2"> </div><br/>
          
           <div id="maltratoPs" style=" height: 400px;"></div><br/><br/>
          <div id="TmaltratoPs"></div>
         <div id="resumenAlumnos3"> </div><br/>
         
          <div id="CvCiudad" style=" height: 400px;"></div><br/><br/>
          <div id="TcvCiudad"></div>
          <div id="resumenAlumnos4"> </div><br/>
          
           <div id="vilFamiliar" style="height: 400px;"></div><br/><br/>
          <div id="TvilFamiliar"></div>
          <div id="resumenAlumnos5"> </div><br/>
    </div>
 ...
 <script src='jsshadow/frmViolenciaReporte.js'></script>
