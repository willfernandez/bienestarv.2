...
<div class="page-header">
	<h1>Salud<small>  Reportes</small></h1>
         ...
         <div class="well filtro">
                    ...
                    <tr>
                            ...
                            <td align="right">
                                <button class="btn btn-primary" type="submit" style="margin-top: -40px" onclick="padEnfermedad('<?php echo $_REQUEST['periodo'];?>','<?php echo $_REQUEST['carrera'];?>','<?php echo $_REQUEST['sede'];?>')">Ver estadisticas</button><br/>
                            </td>
                    </tr>
                    </table>
         </div>
            ...
            <div id="padEnfermedad" style="width: 100%; height: 400px;"></div><br/><br/>
          <div id="TpadEnfermedad"> </div>
          <div id="resumenAlumnos"> </div>
          
        <div id="aatencion" style="width: 100%; height: 400px;"></div><br/><br/>
          <div id="Tatencion"></div>
          <div id="resumenAlumnos2"> </div>
 ...
 <script src='jsshadow/frmSaludReporte.js'></script>
