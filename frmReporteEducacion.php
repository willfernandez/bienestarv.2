...
<div class="page-header">
	<h1>Aspecto Educación<small>  Reportes</small></h1>
</div>
         ...
         <div class="well filtro">
                    ...
                    <tr>
                            ...
                            <td align="right">
                                <button class="btn btn-primary" type="submit" style="margin-top: -40px" onclick="tipoColegio('<?php echo $_REQUEST['periodo'];?>','<?php echo $_REQUEST['carrera'];?>','<?php echo $_REQUEST['sede'];?>')">Ver estadisticas</button><br/>
                            </td>
                    </tr>
                    </table>
         </div>
            ...
            <div id="tipoColegio" style="width: 100%; height: 400px;"></div><br/><br/>
          <div id="TtipoColegio"> </div>
          <div id="resumenAlumnos"> </div><br/>
          
          <div id="RcarreraTec" style="width: 100%; height: 400px;"></div><br/><br/>
          <div id="TcarreraTec"></div>
 ...
 <script src='jsshadow/frmEducacionReporte.js'></script>
