...
function filtrarCarrerasV(){
   ...
   if(periodo=='')
  {
   ...
   var sede = $("#sede_id").val();
    var datos="sede="+sede+"&facultadAl_id="+facultadAl_id+"&periodo="+periodo+"&boton=filtrarCarrerasV";
  //  alert(datos)
    $.ajax({
        type:"POST",
        url: "cCarreras.php",
