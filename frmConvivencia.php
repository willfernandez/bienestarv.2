...
<div class="page-header">
	<h1>Convivencia <small>  Reportes</small><span style="font-size: 12px;margin-left: 300px;font-weight: bold;">Para ver los reportes a nivel de Instición hacer click <a href="frmConvivencia2.php" target='_Blanck'>aquí</a></span></h1>
</div>
         ...
         <div>
             <div id="facultad" style="float:left;"></div>
         </div>
         <button class="btn btn-success" onclick="filtrarCarrerasV();">REPORTE</button>
         <div id="tablaCarreras" style="float:left;"></div>
     ...
     <script src="jsshadow/frmViolenciaRtabl.js"></script>
