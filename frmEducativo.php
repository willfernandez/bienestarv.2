...
<div class="page-header">
	<h1>Educación<small>  Reportes</small><span style="font-size: 12px;margin-left: 300px;font-weight: bold;">Para ver los reportes a nivel de Instición hacer click <a href="frmEducativo2.php" target='_Blanck'>aquí</a></span></h1>
</div>
-
         ...
         <div style="padding-left:0px;float:left">
          ...
          <button class="btn btn-success" onclick="filtrarCarrerasEdu();">REPORTE</button>
      ...
      <script src="jsshadow/frmEducacionRtabl.js"></script>
 </div>
